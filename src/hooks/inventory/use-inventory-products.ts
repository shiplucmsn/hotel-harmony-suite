...
export const productKeys = {
  all: () => withTenantKey(["inventory", "products"] as const),
  list: (params?: Record<string, unknown>) => withTenantKey(["inventory", "products", "list", params] as const),
  detail: (id: string | number) => withTenantKey(["inventory", "products", "detail", id] as const),
};
