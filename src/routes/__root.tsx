...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Nebula ERP — Modern SaaS ERP platform" },
      { name: "description", content: "All-in-one ERP for modern teams. CRM, finance, inventory and analytics, beautifully integrated." },
    ],
